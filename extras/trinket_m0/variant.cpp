...
const PinDescription g_APinDescription[]=
{
  ...
  // --------------------------
  { PORTA, 30, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL | PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC1_CH0, EXTERNAL_INT_10 },
  { PORTA, 31, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL | PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, TCC1_CH1, EXTERNAL_INT_11 },
